            ...
            <div className="thirdColumn">
                ...
                <div className="checkBoxCol">
                    <div className="firstCheck">
                        ...
                        <input type="checkbox" name='TroubleSh' value={TShooting} onChange={(e) => { setTShoot(e.target.value) }} />
                    </div>
                    <div className="firstCheck">
                        <label htmlFor="TroubleSh">Internet/LAN Connection Check-up</label>
                        <input type="checkbox" name='TroubleSh' value={LAN} onChange={(e) => { setLan(e.target.value) }} />
                    </div>
                    <div className="firstCheck">
                        <label htmlFor="TroubleSh">Preventive Maintenance</label>
                        <input type="checkbox" name='TroubleSh' value={preventive} onChange={(e) => { setPrev(e.target.value) }} />
                    </div>
                    <div className="firstCheck">
                        <label htmlFor="TroubleSh">Training and Orientation</label>
                        <input type="checkbox" name='TroubleSh' value={Train} onChange={(e) => { setTrain(e.target.value) }} />
                    </div>
                    <div className="firstCheck">
                        <label htmlFor="TroubleSh">IT Equipment inspection</label>
                        <input type="checkbox" name='TroubleSh' value={equip} onChange={(e) => { setEquip(e.target.value) }} />
                    </div>
                    <div className="firstCheck">
                ...
                <div className="statusBotCon">
                    <div className="statusCon">
                        <div className="completed">
                            ...
                            <label htmlFor="check" value={status} onChange={(e) => { setStatus(e.target.value) }} >Completed</label>
                        </div>
                        <div className="inCom">
                            <input type="checkbox" name='check' />
                            <label htmlFor="check" value={status} onChange={(e) => { setStatus(e.target.value) }} >Incomplete</label>
                        </div>
                    </div>
